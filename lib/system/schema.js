module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© ai.js'
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/FiKzJ7kC1jH1kpZnTYX6y7'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         link: 'https://chat.whatsapp.com/FiKzJ7kC1jH1kpZnTYX6y7'
      }
   }
}